...
function whBuildColdMap(stockMap) {
  ...
  return '<div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">' +
    ...
    '<div style="display:flex;flex-direction:column;gap:4px">' + zoneBlock('B', 4) + '</div></div>' +
    ...
    '<div style="font-size:11px;color:#aaa;writing-mode:vertical-rl">통 로</div></div>' +
    '<div style="display:flex;flex-direction:column;align-items:center">' +
    '<div style="font-size:10px;color:#2980b9;font-weight:700;margin-bottom:4px">C구역</div>' +
    '<div style="display:flex;flex-direction:column;gap:4px">' + zoneBlock('C', 6) + '</div></div>' +
    '<div style="flex:1;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.6);border-radius:6px;border:1px dashed #aaa;min-height:120px">' +
    '<div style="font-size:11px;color:#aaa;writing-mode:vertical-rl">통 로</div></div>' +
    '<div style="display:flex;flex-direction:column;align-items:center">' +
    '<div style="font-size:10px;color:#2980b9;font-weight:700;margin-bottom:4px">D구역</div>' +
    '<div style="display:flex;flex-direction:column;gap:4px">' + zoneBlock('D', 4) + '</div></div>' +
    '<div style="flex:1;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.6);border-radius:6px;border:1px dashed #aaa;min-height:120px">' +
    '<div style="font-size:11px;color:#aaa;writing-mode:vertical-rl">통 로</div></div>' +
    '<div style="display:flex;flex-direction:column;align-items:center">' +
